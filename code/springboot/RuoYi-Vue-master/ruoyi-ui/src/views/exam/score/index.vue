<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="答题卡id" prop="sheetId">
        <el-input
    ...
    <el-table v-loading="loading" :data="scoreList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="答题卡id" align="center" prop="sheetId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="答题卡id" prop="sheetId">
          <el-input v-model="form.sheetId" placeholder="请输入答题卡id" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sheetId: [
          { required: true, message: "答题卡id不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除成绩管理编号为"' + ids + '"的数据项？').then(function() {
        return delScore(ids);
      }).then(() => {
        this.getList();
